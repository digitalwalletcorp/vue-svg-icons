...
<template>
  ...
  >
    ...
    <g :transform="mirrorTransform">
      <!-- 接地影: 針先を起点に、浮いている頭の側へ細く伸ばす -->
      <path
        d="M51.5 130 C 62 127.6, 84 126.2, 100 126.6 a2.6 2.6 0 0 1 0 5.2 C 84 132.2, 62 131.8, 51.5 130 Z"
        fill="#000000"
        opacity="0.10"
      />
      ...
      <g transform="rotate(32 80 84)">
        <!-- 針 -->
        <polygon
          points="77,108 83,108 80.6,136 80,138"
          :fill="`url(#${pinGradId})`"
        />
        <!-- 針の光 -->
        <line x1="78.6" y1="110" x2="80" y2="132" stroke="#ffffff" stroke-width="1" opacity="0.6" />

        <!-- 台座(下の返し: 上すぼまりの逆円錐台) -->
        <path
          d="M62 94 h36 l-8 12 a4 4 0 0 1 -3.5 2 h-13 a4 4 0 0 1 -3.5 -2 Z"
          :fill="`url(#${bodyGradId})`"
          stroke="#9e221c"
          stroke-width="1"
        />
        <!-- 首(くびれた軸) -->
        <path
          d="M71 64 h18 c-1.5 10, -1.5 20, 2 30 h-22 c3.5 -10, 3.5 -20, 2 -30 Z"
          :fill="`url(#${bodyGradId})`"
          stroke="#9e221c"
          stroke-width="1"
        />
        <!-- 頭(上の太い円筒) -->
        <path
          d="M58 42 a22 8 0 0 1 44 0 v16 a22 8 0 0 1 -44 0 Z"
          :fill="`url(#${bodyGradId})`"
          stroke="#9e221c"
          stroke-width="1"
        />
        <!-- 頭の天面(ドーム) -->
        <ellipse cx="80" cy="42" rx="22" ry="8" :fill="`url(#${capGradId})`" stroke="#9e221c" stroke-width="1" />
        <!-- 天面のハイライト -->
        <ellipse cx="74" cy="40" rx="8" ry="2.8" fill="#ffffff" opacity="0.45" />
        <!-- 頭の左側面の縦ハイライト -->
        <path d="M62 46 v10" stroke="#ffffff" stroke-width="2.5" opacity="0.35" stroke-linecap="round" />
      </g>
    </g>
  </svg>
</template>
